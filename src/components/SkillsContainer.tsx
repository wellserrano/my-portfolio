...
export function SkillsContainer() {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 sm:justify-items-center justify-center items-center gap-8">

      <div className="w-96 items-center text-justify">
        <p className="text-lg leading-relaxed text-[#3D3D3D] dark:text-[#F1F2F4]">
          Hi! I am <strong>Wellington Serrano</strong>, a professional web developer with over 3 years of experience in creating dynamic and responsive web/desktop applications.
      ...
      <div className="w-72 h-full ml-14">
        ...
        <Collapsible.Trigger asChild>
          <p className='flex flex-row justify-end items-center gap-2 text-xl font-bold text-[#3D3D3D] dark:text-white mt-8 mb-1  cursor-pointer hover:opacity-75'>
            {languageOpen ? <CaretUp /> : <CaretDown />} Languages 
          </p>
        </Collapsible.Trigger>
        <Collapsible.Content>
